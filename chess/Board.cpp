...
QString Board::name(int id) { return _s[id].name(); }

bool Board::red(int id) { return _s[id]._red; }
...
QPoint Board::center(int id) { return center(_s[id]._row, _s[id]._col); }

QPoint Board::topLeft(int row, int col) {
  return center(row, col) - QPoint(_r, _r);
}

QPoint Board::topLeft(int id) { return center(id) - QPoint(_r, _r); }
...
bool Board::canSelect(int id) { return _bRedTurn == _s[id]._red; }
...
bool Board::isBottomSide(int id) { return _bSide == _s[id]._red; }
...
void Board::back() { backOne(); }

void Board::slotBack() { back(); }
